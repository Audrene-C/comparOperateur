...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1>Admin Page</h1>
            <p>Here you can add, modify and delete any operators as you want.</p>
            <div class="card box effect">
                <div id="add-operator">
                    <h3 class="card-header">Add an operator</h3>
            ...
            <div class="card box-2 effect">
                <div id="add-premium">
                    <form action="../apps/add-premium.php" method="POST">
                        <h3 class="card-header">Add premium to an existing operator</h3>
        ...
        <div class="col-12">
            <div class="card box-2 effect">
                <div id="modify-operator">
                    <h3 class="card-header">Modify an operator</h3>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card box-2 effect">
                <div id="modify-destination box effect">
        ...
        <div class="col-12">
            <div class="card box-2 effect">
                <div id="delete-operator">
                    <h3 class="card-header">Delete an operator</h3>
                    ...
                    <form action="../apps/delete-operator.php" method="POST">
                        ...
                        <input type="submit" value="Delete" class="btn btn-admin">
                    </form>
        ...
        <div class="col-12">
            <div class="card box-2 effect">
                <div id="delete-destination">
                    <h3 class="card-header">Delete a destination</h3>
